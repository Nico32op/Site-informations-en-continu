<template>
  <div id="app">
    ...
    <div class="nav">
      ...
      <p class="btn">
        <router-link class="btn" to="/technologies">Technologies</router-link>
      </p>
      <p class="btn">
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(
        "https://gnews.io/api/v4/top-headlines?token=8c90fa01a622015061484a9fcd8f1dc2&lang=fr&topic=entertainment"
      )
